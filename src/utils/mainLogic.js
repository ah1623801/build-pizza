...
//       +'<filter isMobile ? '' : 'filter="url(#' + fid + ') id="'+fid+'" x="-12%" y="-12%" width="124%" height="124%"> <feTurbulence type="fractalNoise" baseFrequency="0.05" numOctaves="3" seed="'+((Math.random()*100)|0)+'" result="n"/><feDisplacementMap in="SourceGraphic" in2="n" scale="7"/></filter></defs>'
//       +'<g filter="url(#'+fid+')">'
